...
# Поле ввода
entering = Entry(right_frame, width=50, font=("Arial", 14), bg="white")
...
def handle_input(event=None):
    ...
    if action == "add":
        ...
        print_to_output("Ready. Choose an action.")
...
Button(left_frame, text="Share Contact", command=lambda: share_contact_by_email(archieve)).pack(fill=X, pady=2)
